	...
	return(
        ...
        <section className="boxFlex goFullOnMobile">
          ...
          <form className="boxshadow" onSubmit={handleSubmit} style={{width: "54%", display: "grid", rowGap: "15px",}}>
            ...
            <Field nomargin={true} tooltip="sasho" valid={formErr.non_field_errors?false:true} message={formErr.non_field_errors} required={true} onChange={handleInput} prefix="%" value={inputForm.interest_rate} title="Interest Rate" type="number" />
            <Field nomargin={true} tooltip="sasho" valid={formErr.non_field_errors?false:true} message={formErr.non_field_errors} required={true} onChange={handleInput} prefix="$" value={inputForm.term} title="Term" type="number" />
            <Field nomargin={true} tooltip="sasho" valid={formErr.non_field_errors?false:true} message={formErr.non_field_errors} required={true} onChange={handleInput} prefix="$" value={inputForm.monthly_payment} title="Monthly Payment" type="number" />
